...
public class EventSyncTeamsTest {
  ...
  void testLoadTeamsForTournament() {
    ...
    TournamentRecord tournament =
        new TournamentRecord("2026ONHAM", "ONHAM", 2026, "Hamilton District", start, end, 3);
  ...
  void testLoadTeamsForTournamentReplacesExistingTeams() {
    ...
    Instant end = Instant.parse("2026-03-22T00:00:00Z");
    TournamentRecord tournament =
        new TournamentRecord("2026ONHAM2", "ONHAM2", 2026, "Hamilton District 2", start, end, 3);
    tournamentService.save(tournament);
  ...
  void testLoadTeamsForTournamentNoDataFromApi() {
    ...
    Instant end = Instant.parse("2026-03-22T00:00:00Z");
    TournamentRecord tournament =
        new TournamentRecord("2026ONHAM3", "ONHAM3", 2026, "Hamilton District 3", start, end, 3);
    tournamentService.save(tournament);
  ...
  void testLoadTeamsForTournamentEmptyTeamsList() {
    ...
    Instant end = Instant.parse("2026-03-22T00:00:00Z");
    TournamentRecord tournament =
        new TournamentRecord("2026ONHAM4", "ONHAM4", 2026, "Hamilton District 4", start, end, 3);
    tournamentService.save(tournament);
